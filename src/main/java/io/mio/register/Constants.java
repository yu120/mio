...
public class Constants {
    ...
    @Deprecated
    public static final String  SHUTDOWN_WAIT_SECONDS_KEY          = "micro.service.shutdown.wait.seconds";

    public static final String  SHUTDOWN_WAIT_KEY                  = "micro.service.shutdown.wait";
    ...
    public static final String  STUB_EVENT_KEY                     = "micro.stub.event";

    public static final boolean DEFAULT_STUB_EVENT                 = false;

    public static final String  STUB_EVENT_METHODS_KEY             = "micro.stub.event.methods";
