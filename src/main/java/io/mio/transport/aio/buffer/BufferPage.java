...
public class BufferPage {
     ...
     */
    public BufferPage(BufferPage[] poolPages, BufferPage sharedBufferPage, int size, boolean direct) {
    ...
    public VirtualBuffer allocate(final int size) {
        ...
        if (virtualBuffer == null) {
            ...
            log.warn("bufferPage has no available space: " + size);
        }
        return virtualBuffer;
    }
